<template>
    <div class="flex justify-center px-3">
        <div class="flex flex-col max-w-4xl md:h-56 bg-white rounded-lg shadow-lg overflow-hidden md:flex-row my-10">
            <div class="md:flex items-center justify-center md:w-1/2 md:bg-indigo-700">
            ...
            <div class="flex items-center justify-center pb-6 md:py-0 md:w-1/2 md:border-b-8 border-indigo-700">
                <form>
                    <div class="flex flex-col rounded-lg overflow-hidden sm:flex-row">
                        ...
                        <button class="py-3 px-4 bg-indigo-700 text-gray-100 font-semibold uppercase hover:bg-gray-600">subscribe</button>
                    </div>
                </form>
            </div>
        </div>
