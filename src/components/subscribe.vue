<template>
    <div class="flex justify-center px-3">
        <div class="flex flex-col max-w-4xl md:h-56 bg-white px-8 sm:px-20 rounded-lg overflow-hidden md:flex-row my-10">
            <div class="md:flex items-center md:shadow-lg justify-center md:w-2/5 md:bg-indigo-900 md:rounded-l">
            ...
            <div class="flex items-center md:shadow-lg justify-center pb-6 md:py-0 md:w-3/5 md:border-b-8 border-indigo-900">
                <form>
                    <div class="flex flex-col rounded-lg overflow-hidden sm:flex-row">
                        ...
                        <button class="py-3 px-4 bg-indigo-900 text-gray-100 font-semibold uppercase hover:bg-gray-600">subscribe</button>
                    </div>
                </form>
            </div>
        </div>
