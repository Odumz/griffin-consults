<template>
    <div class="flex justify-center px-3">
        <div class="flex flex-col max-w-4xl md:h-56 bg-white rounded-lg shadow-lg overflow-hidden md:flex-row my-10">
            <div class="md:flex items-center justify-center md:w-2/5 md:bg-indigo-700">
            ...
            <div class="flex items-center justify-center pb-6 md:py-0 md:w-3/5 md:border-b-8 border-indigo-700">
                <form>
