<template>
    <div>
        <div class="min-w-screen min-h-screen bg-gry-900 flex items-center justify-center px-5 py-5">
            <div class="bg-gray-100 dark:bg-gray-800 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-bold text-3xl text-gray-900 dark:text-gray-300">REGISTER</h1>
                        ...
                        <div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <btn name="simple"><p class="px-20 py-2 font-semibold">REGISTER NOW</p></btn>
                                </div>
                            </div>
                        </div>
                    </div>
